 ...
 * 结果：
 * 接受请求的线程名称：http-nio-8080-exec-1
 * 返回请求的线程名称：http-nio-8080-exec-1
 * 处理过程的线程名称：http-nio-8080-exec-2
 * <p>
 * 测试例子2：
 * url： http://localhost:8080/servlet3/myAsyn?flag=0
 * 结果：
 * 接受请求的线程名称：http-nio-8080-exec-3
 * 处理过程的线程名称：http-nio-8080-exec-3
 * 返回请求的线程名称：http-nio-8080-exec-3
 * <p>
 * 总结：
...
public class MyAsynServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("接受请求的线程名称：" + Thread.currentThread().getName());
        ...
        System.out.println("返回请求的线程名称：" + Thread.currentThread().getName());
    ...
    public void executeTaskNoResult() {
        try {
            System.out.println("处理过程的线程名称：" + Thread.currentThread().getName());
            Thread.sleep(5000);
